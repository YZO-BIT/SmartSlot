    ...
    public CommandLineRunner initializeDatabase() {
        return args -> {
            ...
            if (sectionRepository.count() == 0) {
                ...
                section1.setName("CSE-A");
                section1.setBatchYear(2024);
                section1.setStudentCount(45);
                sectionRepository.save(section1);

                Section section2 = new Section();
                section2.setName("CSE-B");
                section2.setBatchYear(2024);
                section2.setStudentCount(48);
                sectionRepository.save(section2);

                Section section3 = new Section();
                section3.setName("CSE-C");
                section3.setBatchYear(2024);
                section3.setStudentCount(42);
                sectionRepository.save(section3);

                System.out.println("✓ 3 Sections initialized successfully!");
                System.out.println("  - CSE-A: 45 students");
                System.out.println("  - CSE-B: 48 students");
                System.out.println("  - CSE-C: 42 students");
            }
            ...
            if (electiveGroupRepository.count() == 0) {
                ...
                if (allSections.size() >= 3) {
                    Section sectionA = allSections.get(0); // CSE-A
                    Section sectionB = allSections.get(1); // CSE-B
                    Section sectionC = allSections.get(2); // CSE-C

                    // Create Elective Group G1: AI & ML (all sections combined)
                    ElectiveGroup group1 = new ElectiveGroup();
                    group1.setGroupName("G1");
                    group1.setDescription("AI & Machine Learning Elective (CSE-A, CSE-B, CSE-C combined)");
                    group1.setActive(true);
                    group1.getSections().add(sectionA);
                    group1.getSections().add(sectionB);
                    group1.getSections().add(sectionC);
                    ...
                    if (allSections.size() >= 2) {
                        ...
                        group2.setDescription("Cloud Computing Elective (CSE-A, CSE-B combined)");
                        group2.setActive(true);
                        group2.getSections().add(sectionA);
                        group2.getSections().add(sectionB);
